    ...
    <div className="session-picker fixed inset-0 z-[99] flex items-start justify-center">
      ...
      >
        ...
        <div className="max-h-60 overflow-y-auto">
          {loading ? (
            <div className="px-3 py-3 text-base text-text-tertiary">Loading...</div>
          ) : visibleSessions.length === 0 ? (
            <div className="px-3 py-3 text-base text-text-tertiary">No active sessions</div>
          ) : (
              ...
              return (
                ...
                >
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    {basename && <div className="text-sm text-text-muted truncate">{basename}</div>}
                  </div>
                </div>
              )
            })
        ...
        <div className="border-t border-border-default">
          ...
          >
            ...
            <span className="text-base text-text-muted">Create New Session...</span>
          </div>
        </div>
      </div>
    </div>
