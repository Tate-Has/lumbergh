...
import { Monitor, Info, ArrowUpCircle, X, Star, FolderOpen, Plus } from 'lucide-react'
...
export default function Dashboard() {
  ...
  useEffect(() => {
    ...
    // Listen for session changes from AppHeader
    const onSessionsChanged = () => fetchSessions()
    window.addEventListener('lumbergh:sessions-changed', onSessionsChanged)
    return () => {
      clearInterval(interval)
      window.removeEventListener('lumbergh:sessions-changed', onSessionsChanged)
    }
  }, [
    fetchSessions,
    fetchPlanInfo,
