...
A self-hosted web dashboard for supervising multiple Codex AI sessions running in tmux. Think "micromanager for your AI interns."

## Project Overview

Lumbergh provides a web UI to:
- View and interact with multiple Codex terminal sessions (via xterm.js + WebSockets)
...
This creates a tmux session with Codex, backend (port 8420), and frontend (port 5420) windows and opens the browser.
